import { compact, fromPairs, get, has, isPlainObject, isUndefined, map, omitBy, pick, pipe, toPairs, } from "lodash";
...
class ServerlessOfflineSQS {
    ...
    _mergeOptions() {
        ...
        this.options = Object.assign({}, omitUndefined(defaultOptions), omitUndefined(provider), omitUndefined(pick("location", offlineOptions)), // serverless-webpack support
    ...
    _resolveFn(obj) {
        ...
        return pipe(toPairs, map(([key, value]) => {
