...
var _sqsEventDefinition = require("./sqs-event-definition");

var _sqsEventDefinition2 = _interopRequireDefault(_sqsEventDefinition);

var _sqsEvent2 = require("./sqs-event");
...
var SQS = function () {
  ...
  _createClass(SQS, [{
    ...
    value: function create(events) {
      ...
      return Promise.all(events.map(function (_ref) {
    ...
    value: function _create(functionKey, rawSqsEventDefinition) {
      var sqsEvent = new _sqsEventDefinition2.default(rawSqsEventDefinition, this.options.region, this.options.accountId);
    ...
    key: "_getQueueUrl",
    value: function () {
      var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(queueName) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return this.client.getQueueUrl({ QueueName: queueName }).promise();
              ...
              case 10:
                return _context.abrupt("return", this._getQueueUrl(queueName));
    ...
    key: "_sqsEvent",
    value: function () {
      var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(functionKey, sqsEvent) {
        var _this2 = this;
        ...
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                enabled = sqsEvent.enabled, arn = sqsEvent.arn, queueName = sqsEvent.queueName, batchSize = sqsEvent.batchSize;
              ...
              case 9:
                ...
                QueueUrl = _context3.t0._rewriteQueueUrl.call(_context3.t0, _context3.t1);
                    ...
                    return regeneratorRuntime.wrap(function _callee2$(_context2) {
                      while (1) {
                        switch (_context2.prev = _context2.next) {
                          case 0:
                            _context2.next = 2;
                            return _this2.client.receiveMessage({
                              QueueUrl: QueueUrl,
                          ...
                          case 2:
                            ...
                            _context2.prev = 5;
                            lambdaFunction = _this2.lambda.get(functionKey);
                            event = new _sqsEvent3.default(Messages, _this2.region, arn);
                          ...
                          case 11:
                            _context2.next = 13;
                            return _this2.client.deleteMessageBatch({
                              Entries: (Messages || []).map(function (_ref7) {
                                var Id = _ref7.MessageId,
                                    ReceiptHandle = _ref7.ReceiptHandle;
                                return {
                                  Id: Id,
    ...
    value: function _getResourceProperties(queueName) {
      return (0, _lodash.pipe)(_lodash.values, (0, _lodash.find)((0, _lodash.matches)({ Properties: { QueueName: queueName } })), (0, _lodash.get)("Properties"))(this.resources);
    }
  }, {
    key: "_createQueue",
    value: function () {
      var _ref9 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(_ref8) {
        ...
        var remainingTry = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 5;
        var properties;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return this.client.createQueue({
                  ...
                  Attributes: (0, _lodash.mapValues)(function (value) {
                    return (0, _lodash.isPlainObject)(value) ? JSON.stringify(value) : (0, _lodash.toString)(value);
                  }, properties)
                }).promise();
              ...
              case 6:
                ...
                if (!(remainingTry > 0 && _context4.t0.name === "AWS.SimpleQueueService.NonExistentQueue")) {
                  _context4.next = 10;
                  break;
                }

                return _context4.abrupt("return", this._createQueue({ queueName: queueName }, remainingTry - 1));
