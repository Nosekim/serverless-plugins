                ...
                while (1) {
                  switch ((_context.prev = _context.next)) {
                    case 0:
                      ...
                      (_getEvents2 = this._getEvents()),
                        (sqsEvents = _getEvents2.sqsEvents),
                        (lambdas = _getEvents2.lambdas);
                ...
                while (1) {
                  switch ((_context3.prev = _context3.next)) {
                    ...
                    case 2:
                      ...
                      console.log(
                        "Got " + command + " signal. Offline Halting..."
                      );
    ...
    },
    {
      ...
      value: (function () {
        var _ref5 = _asyncToGenerator(
          /*#__PURE__*/ regeneratorRuntime.mark(function _callee5(skipExit) {
            var eventModules;
            return regeneratorRuntime.wrap(
                ...
                while (1) {
                  switch ((_context5.prev = _context5.next)) {
                    ...
                    case 2:
                      ...
                      if (this.sqs) {
                        eventModules.push(
                          this.sqs.stop(SERVER_SHUTDOWN_TIMEOUT)
                        );
                      }
    ...
    },
    {
      ...
      value: function _mergeOptions() {
        var _serverless$service = this.serverless.service,
          ...
          custom =
            _serverless$service$c === undefined ? {} : _serverless$service$c,
        ...
        this.options = Object.assign(
          ...
          omitUndefined((0, _lodash.pick)("location", offlineOptions)), // serverless-webpack support
                  ...
                  switch (type) {
                    case "AWS::SQS::Queue": {
                      ...
                      return [
                        key,
                        "arn:aws:sqs:" +
                          _this2.options.region +
                          ":" +
                          _this2.options.accountId +
                          ":" +
                          queueName,
                      ];
                    }
